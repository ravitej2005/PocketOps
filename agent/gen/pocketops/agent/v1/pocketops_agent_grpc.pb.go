...
const (
	AgentControl_Connect_FullMethodName = "/pocketops.agent.v1.AgentControl/Connect"
)
...
func (c *agentControlClient) Connect(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[AgentEnvelope, ServerEnvelope], error) {
...
type AgentControl_ConnectClient = grpc.BidiStreamingClient[AgentEnvelope, ServerEnvelope]
...
func (UnimplementedAgentControlServer) Connect(grpc.BidiStreamingServer[AgentEnvelope, ServerEnvelope]) error {
...
func _AgentControl_Connect_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(AgentControlServer).Connect(&grpc.GenericServerStream[AgentEnvelope, ServerEnvelope]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type AgentControl_ConnectServer = grpc.BidiStreamingServer[AgentEnvelope, ServerEnvelope]
...
var AgentControl_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pocketops.agent.v1.AgentControl",
	...
	Metadata: "pocketops_agent.proto",
}
